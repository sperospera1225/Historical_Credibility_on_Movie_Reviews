...
count = 1
overlap = 0
f3 = open("D:/movie_review/new_data_review/the_outlaws/baseline_old/review_history_undecided.txt", "w", encoding='utf-8')
f4 = open("D:/movie_review/new_data_review/the_outlaws/baseline_old/review_history_helpful.txt", "w", encoding='utf-8')
f5 = open("D:/movie_review/new_data_review/the_outlaws/baseline_old/review_history_unhelpful.txt", "w", encoding='utf-8')
number1 = 0
number2 = 0
number3 = 0
number4 = 0
while (count <= 21266):  # review_data.json 갯수
    labeled1 = True
    labeled2 = True
    labeled3 = True
    ...
    if sympathy_int + unsympathy_int >= 3 and sympathy_int/(unsympathy_int+sympathy_int)>0.7:
        labeled2 = False
    elif sympathy_int + unsympathy_int >= 3 and unsympathy_int > sympathy_int:
        labeled2 = True
        labeled3 = True
    else:
        labeled2 = True
