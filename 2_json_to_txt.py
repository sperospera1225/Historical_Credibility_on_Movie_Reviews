...
f1 = open("D:/movie_review/new_data_review/Intimates strangers/baseline_old/trusted2.txt", "w", encoding='utf-8')
f2 = open("D:/movie_review/new_data_review/Intimates strangers/baseline_old/untrusted2.txt", "w", encoding='utf-8')
